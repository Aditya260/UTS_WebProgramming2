...
<div class="row mt-12 float-right">
    <div class="col-md-12">
...
<div class="row mt-3">
    <div class="col-md-6">
        <a href="<?= base_url();?>cabang/tambah" class ="btn btn-primary"><i class="fas fa-plus"></i> &nbsp;Tambah Data Cabang</a>
    </div>
</div>
    ...
    <div class="col-md-6">
        ...
        <?php foreach ($cabang as $cabang) :?>
            <li class="list-group-item">
                ...
                <a href="<?= base_url(); ?>cabang/ubah/<?= $cabang['id']; ?>
                " class="badge badge-success float-right" >ubah</a>
                <a href="<?= base_url(); ?>cabang/detail/<?= $cabang['id']; ?>
