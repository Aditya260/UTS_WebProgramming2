...
<div class="row mt-3">
    <div class="col-md-6">
        ...
        role="alert">
            Data karyawan <strong>berhasil</strong> <?= 
    ...
    <div class="col-md-6">
        ...
        <?php foreach ($karyawan as $karyawan) :?>
            <li class="list-group-item">
                <?= $karyawan['nama']; ?>
                <a href="<?= base_url(); ?>karyawan/hapus/<?= $karyawan['id']; ?>
                " class="badge badge-danger float-right" onclick="return confirm('yakin?');">hapus</a>
                <a href="<?= base_url(); ?>karyawan/ubah/<?= $karyawan['id']; ?>
                " class="badge badge-success float-right" >ubah</a>
                <a href="<?= base_url(); ?>karyawan/detail/<?= $karyawan['id']; ?>
